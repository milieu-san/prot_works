...
ActiveRecord::Schema.define(version: 20_190_222_031_609) do
  ...
  create_table 'goods', force: :cascade do |t|
    ...
    t.index %w[user_id review_id], name: 'index_goods_on_user_id_and_review_id', unique: true
  ...
  create_table 'hearts', force: :cascade do |t|
    ...
    t.index %w[user_id prot_id], name: 'index_hearts_on_user_id_and_prot_id', unique: true
  ...
  create_table 'stars', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[give_user_id take_user_id], name: 'index_stars_on_give_user_id_and_take_user_id', unique: true
